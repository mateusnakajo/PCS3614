...
public class ConexaoWeb {
  ...
  public void TrataConexao() {
    ...
    String raiz1 = "/home/mateus/Documents/Redes/parte2/html"; 				//String para o diretorio raiz.
    String raiz2 = "/home/mateus/Documents/Redes/parte2/html1";        //String para o diretorio raiz.
    String raiz = raiz1;
      ...
      String str;
        while ((str = in.readLine()) != null && !str.equals("")) {
          if(str.startsWith("Host")) {
            ...
            raiz = host.startsWith("localhost") ? raiz1 : raiz2;
          }
